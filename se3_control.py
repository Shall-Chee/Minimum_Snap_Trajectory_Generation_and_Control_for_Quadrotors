...
class SE3Control(object):
    ...
    def update(self, t, state, flat_output):
        ...
        acc_des = flat_output['x_ddot'] - np.dot(K_d, (state['v'] - flat_output['x_dot'])) - np.dot(K_p, (
        ...
        a_psi = np.array([np.cos(flat_output['yaw']), np.sin(flat_output['yaw']),
                          0])  # defines the yaw direction in the plane (a1, a2) plane
